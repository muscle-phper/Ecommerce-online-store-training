...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="/online_auction/public/css/dashboard.css" rel="stylesheet">
  ...
  <body>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li>
              <a href="http://localhost/online_auction/index.php/account/member_manage">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <?php foreach($member_list as $row) :?>
                  <tr>
                    <td>
                    <a href="http://localhost/online_auction/index.php/account/member_edit">編輯</a>
                    |<a href="http://localhost/online_auction/index.php/account/member_delete">刪除</a>
                    </td>
                    <td><?=$row->sno?></td>
                    <td><?=$row->name?></td>
                    <td><?=$row->address?></td>
    ...
    <script src="/online_auction/public/js/jquery.min.js"></script>
    <script src="/online_auction/public/js/bootstrap.min.js"></script>
    <!-- Just to make our placeholder images work. Don't actually copy the next line! -->
    <script src="/online_auction/public/js/holder.min.js"></script>
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
